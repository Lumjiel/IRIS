<template>
  <header class="h-12 border-b border-slate-200/70 dark:border-slate-700/60 bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl px-4 flex items-center justify-between gap-3 shrink-0">
